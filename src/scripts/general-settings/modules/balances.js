...
const showWalletOption = ({ state }) => {
  ...
  return `
    <div class="option-container">
      ...
      <p class="option-description">The "Wallet" balance is the <em>total</em> balance of your Blocknet wallet. This is useful you are when using a separate Blocknet wallet for trading and still want to see the balance of your main Blocknet wallet, which is where fees are paid from.</p>
