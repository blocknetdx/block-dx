              ...
              <div class="col2-no-margin">
                ${addingWallets ?
                  `
                    ...
                    <p style="${styles.p}"><strong style="margin-right: 10px;">1)</strong> The wallets for each of the newly added assets must be restarted to load the new configurations. Make sure that the wallets have been encrypted (Settings > Encrypt), synced, and are fully unlocked (Settings > Unlock Wallet).</p>
                    <p style="${styles.p}"><strong style="margin-right: 10px;">2)</strong> Open, sync, and fully unlock the <a href="#" class="text-link js-blocknetWalletLink">Blocknet wallet</a>.</p>
                    <p style="${styles.p}"><strong style="margin-right: 10px;">3)</strong> Select RESTART to restart Block DX and begin trading.</p>
                  `
                : updatingWallets ?
                  `
                    <p style="${styles.p}">Before the updated assets can be traded on Block DX, <strong>the wallets for each of the updated assets must be restarted</strong> to load the new configurations. This includes the Blocknet wallet if it was updated.</p>
                  `
                :
                  `
                    <p style="${styles.p}">Before Block DX can be used, these last few steps must be completed:</p>
                    <p style="${styles.p}"><strong style="margin-right: 10px;">1)</strong> Open the wallets of any assets you'll be trading. If any are already open, you will need to restart them in order to activate the new configurations. Make sure that the wallets have been encrypted (Settings > Encrypt) and are fully unlocked (Settings > Unlock Wallet).</p>
                    <p style="${styles.p}"><strong style="margin-right: 10px;">2)</strong> Open the <a href="#" class="text-link js-blocknetWalletLink">Blocknet wallet</a>. If it is already open, you will need to restart it in order to activate the new configurations. Make sure that the wallet has been encrypted (Settings > Encrypt) and is fully unlocked (Settings > Unlock Wallet).</p>
                    <p style="${styles.p}"><strong style="margin-right: 10px;">3)</strong> Select RESTART to restart Block DX and begin trading.</p>
                  `
                }
