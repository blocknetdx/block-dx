const renderSettings1 = ({ state }) => {
  ...
  const html = `
          <p style="margin-top:0;padding-top:0;padding-left:10px;padding-right:10px;margin-bottom:5px;">Usernames and passwords must be created for the wallets of each token that will be traded.</p>
