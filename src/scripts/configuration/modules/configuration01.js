...
const renderConfiguration1 = ({ state }) => {
  ...
  const html = `
          <p style="margin-top:0;padding-top:0;padding-left:10px;padding-right:10px;margin-bottom:10px;">In order to conduct peer-to-peer trades, Block DX requires the Blocknet wallet and the wallets of any tokens you want to trade with. Select the wallets that are installed to begin setup.</p>
