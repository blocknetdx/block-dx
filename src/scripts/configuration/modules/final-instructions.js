const renderFinalInstructions = () => {
  const html = `
          ...
          <p style="margin-top:0;padding-top:0;padding-left:10px;padding-right:10px;margin-bottom:5px;"><strong style="margin-right: 10px;">2)</strong> Open the Blocknet wallet. If it is already open, you will need to restart it in order to activate the new configurations. Make sure that the wallet has been encrypted (Settings > Encrypt) and is unlocked (Settings > Unlock Wallet).</p>
