const renderComplete = () => {
  const html = `
          <p style="margin-top:0;padding-top:0;padding-left:10px;padding-right:10px;margin-bottom:5px;">Upon selecting 'Finish', the configurations set will be saved.</p>
