...
@Component({
  selector: 'app-pair-selector-new',
  templateUrl: './pair-selector-new.component.html',
  styleUrls: ['./pair-selector-new.component.scss'],
  animations: [fadeInOut]
})
export class PairSelectorNewComponent implements OnInit, AfterViewInit {
    ...
    switch(this.state) {
      case 'stage1' :
        arr = [
          ...
          {title: this.allTokensLabel, rows: PairSelectorNewComponent.uniqueCoinsNotIn(this._allCoins, this._userWallet)}
        ];
        break;
      case 'stage2' :
      case 'stage3' :
        arr = [
          ...
          {title: this.allTokensLabel, rows: PairSelectorNewComponent.uniqueCoins(this._allCoins.filter(c => c.symbol !== this.model.coinA.symbol))}
        ];
        break;
    }
    return arr;
  ...
  currencyComparisons(symbol) {
    return PairSelectorNewComponent.uniqueCoinsNotIn(this._allCoins
