...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    ...
    return { tradehistory_ETH, tradehistory_BTC, orderbook_BTC, orderbook_ETH, dxOrderbook, dxTradeHistory, priceChart, stats_ETH, stats_BTC };
  }
}
