...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    ...
    return { tradehistoryETH, tradehistoryBTC, orderbookBTC, orderbookETH, dxOrderbook, dxTradeHistory, priceChart, statsETH, statsBTC };
  }
}
